...
To install lm, run this command in your terminal:

.. code-block:: console

    $ pip install lm

This is the preferred method to install lm, as it will always install the most recent stable release.
...
The sources for lm can be downloaded from the `Github repo`_.
